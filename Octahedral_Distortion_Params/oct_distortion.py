...
def octahedral_elongation(center_octahedral_array, sharedIIndexes):
    return
#---------------------------------------------------------------------------
...
struct2 = vasp.inputs.Poscar.from_file("PBEsol_CONTCAR").structure
struct2.make_supercell([3, 1, 3])
struct2_species = struct2.species
