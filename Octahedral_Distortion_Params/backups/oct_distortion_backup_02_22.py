...
def get_center_octahedral(octahedral_array):
...
def get_neighbor_info(center_octahedrals, octahedral_array, struct):
...
center_octahedrals = get_center_octahedral(octahedral_array)

# The below function will print out all the octahedral distortion
# parameters of interest in an organized fashion. 
get_neighbor_info(center_octahedrals, octahedral_array, struct)
